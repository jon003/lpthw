...
self	Inside the functions in a class, self is a variable for the instance/object
		being accessed.
inheritance	The concept that one class can inherit trains from another class, 
...
has-a 	A phrase to say that something is composed of other things or has a train, 
